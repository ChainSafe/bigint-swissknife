...
This project is part of the [bigint-swissknife](https://github.com/ChainSafe/bigint-swissknife) project. It provides a BigInt wrapper class that enforces bounds checking on arithmetic operations.
